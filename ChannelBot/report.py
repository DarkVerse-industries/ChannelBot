...
async def _manage(_, msg):
    ...
    how += '2) Visit @DarkVerseIndustries and define your problem **completely**, i.e, what you expected and what happened instead.'
    how += "If you don't get a reply, tag an admin."
    await msg.reply(
        how,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('Support Group', url='https://t.me/DarkVerseIndustries')]
        ]),
        quote=True
    )
